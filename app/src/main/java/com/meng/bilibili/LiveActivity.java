...
public class LiveActivity extends Activity{
	...
	public void readContentFromPost(String msg) throws IOException {
	  final int roomId=1;
	...
	//	发送弹幕貌似要检查User-Agent和cookie Referer貌似并没有检查但发送的数据中包含这一项于是就加上了
		...
		runOnUiThread(new Runnable(){
			  ...
			  @Override
			  public void run(){
				  Toast.makeText(LiveActivity.this,roomId+"已奶",Toast.LENGTH_SHORT).show();
				}
			});	
	}
