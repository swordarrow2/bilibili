    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (bilibiliImageFile.exists()) {
            ...
            if (MainActivity.onWifi) {
                MainActivity.instance.threadPool.execute(new DownloadImageRunnable(activity, holder.ivHeader, String.valueOf(account.uid), DownloadImageRunnable.BilibiliUser));
            } else {
