    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.close.setOnClickListener(new OnClickListener(){
				...
				public void onClick(View p1) {
					...
					showRecent(recents.get(0));
				}
			});
        return convertView;
    }
	
	private void showRecent(Recent r){
		switch (r.type) {
			case Video:
			...
			case Dynamic:
				...
				break;
			case egHome:
				MainActivity.instance.showFragment(HomeFragment.class, IDType.egHome);
				break;
			case egMenu:
				MainActivity.instance.showFragment(MenusFragment.class, IDType.egMenu);
				break;
			case egProgress:
				MainActivity.instance.showFragment(ProgressFragment.class, IDType.egProgress);
				break;
		}
	}
