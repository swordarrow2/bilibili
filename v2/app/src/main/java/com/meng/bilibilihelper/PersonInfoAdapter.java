...
public class PersonInfoAdapter extends BaseAdapter {
    ...
    private ArrayList<PlanePlayer> infos;

    public PersonInfoAdapter(Activity context, ArrayList<PlanePlayer> infos) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final PlanePlayer personInfo = infos.get(position);
