...
public class MainActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState){
		...
		Toast.makeText(MainActivity.this,SharedPreferenceHelper.getString("cookie","null"),Toast.LENGTH_SHORT).show();
		if(SharedPreferenceHelper.getString("cookie","null").equals("null")){	 
