...
public class screenshotListener {
    ...
    private screenshotListener(Context context) {
        ...
        if (sScreenRealSize == null) {
            ...
            if (sScreenRealSize != null) {
                Log.i("x", "Screen Real Size: " + sScreenRealSize.x + " * " + sScreenRealSize.y);
            } else {
                Log.i("x", "Get screen real size failed.");
            }
        }
    }
    ...
    private void handleMediaContentChange(Uri contentUri) {
        ...
        try {
            ...
            if (cursor == null) {
                Log.i("x", "Deviant logic.");
                return;
            }
            if (!cursor.moveToFirst()) {
                Log.i("x", "Cursor no data.");
                return;
            }
    ...
    private void handleMediaRowData(String data, long dateTaken, int width, int height) {
        if (checkScreenShot(data, dateTaken, width, height)) {
            Log.i("x", "ScreenShot: path = " + data + "; size = " + width + " * " + height
                    + "; date = " + dateTaken);
            ...
            Log.i("x", "Media content changed, but not screenshot: path = " + data
